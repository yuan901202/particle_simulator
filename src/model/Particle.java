...
public class Particle {
  ...
  public void interact(Model m){
    for(Particle p:m.p){
      if(p==this)continue;
      //signum returns the argument either 1.0 or -1.0.
      //If argument value is less than zero, it will return -1.0 value
      //and argument is greater than zero or zero, it will return 1.0.
      ...
      //it is a compile-time error if Expression2 is void
